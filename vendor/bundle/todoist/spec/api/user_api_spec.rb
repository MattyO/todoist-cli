...
# Unit tests for Todoist::UserApi
...
describe "UserApi" do
  ...
  describe "test an instance of UserApi" do
    it "should create an instance of UserApi" do
      expect(@api_instance).to be_instance_of(Todoist::UserApi)
    end
  end

  # unit tests for get_productivity_stats_api_v1_tasks_completed_stats_get
  # Get Productivity Stats
  # @param [Hash] opts the optional parameters
  # @return [Hash<String, Object>]
  describe "get_productivity_stats_api_v1_tasks_completed_stats_get test" do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_notification_setting_api_v1_notification_setting_put
  ...
  describe "update_notification_setting_api_v1_notification_setting_put test" do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for user_info_api_v1_user_get
  # User Info
  # @param [Hash] opts the optional parameters
  # @return [Hash<String, Object>]
  describe "user_info_api_v1_user_get test" do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
