...
# Unit tests for Todoist::ActivityApi
...
describe "ActivityApi" do
  ...
  describe "test an instance of ActivityApi" do
    it "should create an instance of ActivityApi" do
      expect(@api_instance).to be_instance_of(Todoist::ActivityApi)
    end
  end

  # unit tests for get_activity_logs_api_v1_activities_get
  # Get Activity Logs
  ...
  # @option opts [Boolean] :include_parent_object
  # @option opts [Boolean] :include_child_objects
  # @option opts [Integer] :initiator_id
  # @option opts [Boolean] :initiator_id_null
  # @option opts [String] :event_type
  # @option opts [Boolean] :ensure_last_state
  # @option opts [Boolean] :annotate_notes
  # @option opts [Boolean] :annotate_parents
  # @option opts [String] :cursor
  # @option opts [Integer] :limit
  # @option opts [Array<String>] :request_body
  # @return [PaginatedListActivityEvents]
  describe "get_activity_logs_api_v1_activities_get test" do
    it "should work" do
