...
describe 'IdsApi' do
  ...
  describe 'test an instance of IdsApi' do
    it 'should create an instance of IdsApi' do
      expect(@api_instance).to be_instance_of(Todoist::IdsApi)
    end
  end

  # unit tests for id_mappings_api_v1_id_mappings_obj_name_obj_ids_get
  # Id Mappings
  ...
  describe 'id_mappings_api_v1_id_mappings_obj_name_obj_ids_get test' do
    it 'should work' do
