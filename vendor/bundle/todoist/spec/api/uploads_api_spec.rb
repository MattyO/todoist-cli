...
# Unit tests for Todoist::UploadsApi
...
describe 'UploadsApi' do
  ...
  describe 'test an instance of UploadsApi' do
    it 'should create an instance of UploadsApi' do
      expect(@api_instance).to be_instance_of(Todoist::UploadsApi)
    end
  end

  # unit tests for delete_upload_api_v1_uploads_delete
  # Delete Upload
  # @param file_url 
  # @param [Hash] opts the optional parameters
  # @return [String]
  describe 'delete_upload_api_v1_uploads_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for upload_file_api_v1_uploads_post
  # Upload File
  # @param todoist_apps_api_sync_rest_controller_body 
  # @param [Hash] opts the optional parameters
  # @return [UploadResult]
  describe 'upload_file_api_v1_uploads_post test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
