...
# Unit tests for Todoist::CommentsApi
...
describe "CommentsApi" do
  ...
  describe "test an instance of CommentsApi" do
    it "should create an instance of CommentsApi" do
      expect(@api_instance).to be_instance_of(Todoist::CommentsApi)
    end
  end

  # unit tests for create_comment_api_v1_comments_post
  # Create Comment
  # Creates a new comment on a project or task and returns it.  One of &#x60;task_id&#x60; or &#x60;project_id&#x60; arguments is required.
  # @param todoist_apps_api_rest_comments_body1
  # @param [Hash] opts the optional parameters
  # @return [NoteSyncView]
  describe "create_comment_api_v1_comments_post test" do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_comment_api_v1_comments_comment_id_delete
  # Delete Comment
  # Delete a comment by ID
  # @param comment_id
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe "delete_comment_api_v1_comments_comment_id_delete test" do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_comment_api_v1_comments_comment_id_get
  # Get Comment
  # Returns a single comment by ID
  # @param comment_id
  # @param [Hash] opts the optional parameters
  # @return [NoteSyncView]
  describe "get_comment_api_v1_comments_comment_id_get test" do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_comments_api_v1_comments_get
  # Get Comments
  ...
  describe "get_comments_api_v1_comments_get test" do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_comment_api_v1_comments_comment_id_post
  # Update Comment
  # Update a comment by ID and returns its content
  # @param comment_id
  # @param todoist_apps_api_rest_comments_body2
  # @param [Hash] opts the optional parameters
  # @return [NoteSyncView]
  describe "update_comment_api_v1_comments_comment_id_post test" do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
