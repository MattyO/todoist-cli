...
# Unit tests for Todoist::EmailsApi
...
describe 'EmailsApi' do
  ...
  describe 'test an instance of EmailsApi' do
    it 'should create an instance of EmailsApi' do
      expect(@api_instance).to be_instance_of(Todoist::EmailsApi)
    end
  end

  # unit tests for email_disable_api_v1_emails_delete
  # Email Disable
  ...
  describe 'email_disable_api_v1_emails_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for email_get_or_create_api_v1_emails_put
  # Email Get Or Create
  ...
  describe 'email_get_or_create_api_v1_emails_put test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
