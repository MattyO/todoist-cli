...
# Unit tests for Todoist::AuthorizationApi
...
describe 'AuthorizationApi' do
  ...
  describe 'test an instance of AuthorizationApi' do
    it 'should create an instance of AuthorizationApi' do
      expect(@api_instance).to be_instance_of(Todoist::AuthorizationApi)
    end
  end

  # unit tests for migrate_personal_token_api_v1_access_tokens_migrate_personal_token_post
  ...
  # @param todoist_apps_app_platform_controllers_access_token_body 
  # @param [Hash] opts the optional parameters
  # @return [MigratePersonalTokenResponse]
  describe 'migrate_personal_token_api_v1_access_tokens_migrate_personal_token_post test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for revoke_access_token_api_api_v1_access_tokens_delete
  ...
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'revoke_access_token_api_api_v1_access_tokens_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
