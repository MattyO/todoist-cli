...
# Unit tests for Todoist::WorkspaceInvitationView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::WorkspaceInvitationView do
  let(:instance) { Todoist::WorkspaceInvitationView.new }

  describe "test an instance of WorkspaceInvitationView" do
    it "should create an instance of WorkspaceInvitationView" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::WorkspaceInvitationView)
    end
  end
  ...
  describe 'test attribute "is_existing_user"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
