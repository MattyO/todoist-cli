...
# Unit tests for Todoist::PaginatedListStr
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PaginatedListStr do
  let(:instance) { Todoist::PaginatedListStr.new }

  describe 'test an instance of PaginatedListStr' do
    it 'should create an instance of PaginatedListStr' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::PaginatedListStr)
    end
  end
