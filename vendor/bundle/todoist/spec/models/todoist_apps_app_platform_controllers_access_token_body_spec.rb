...
# Unit tests for Todoist::TodoistAppsAppPlatformControllersAccessTokenBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsAppPlatformControllersAccessTokenBody do
  let(:instance) { Todoist::TodoistAppsAppPlatformControllersAccessTokenBody.new }

  describe "test an instance of TodoistAppsAppPlatformControllersAccessTokenBody" do
    it "should create an instance of TodoistAppsAppPlatformControllersAccessTokenBody" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsAppPlatformControllersAccessTokenBody)
    end
  end
