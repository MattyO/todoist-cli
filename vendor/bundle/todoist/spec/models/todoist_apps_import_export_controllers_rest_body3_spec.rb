...
# Unit tests for Todoist::TodoistAppsImportExportControllersRestBody3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsImportExportControllersRestBody3 do
  let(:instance) { Todoist::TodoistAppsImportExportControllersRestBody3.new }

  describe 'test an instance of TodoistAppsImportExportControllersRestBody3' do
    it 'should create an instance of TodoistAppsImportExportControllersRestBody3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsImportExportControllersRestBody3)
    end
  end
