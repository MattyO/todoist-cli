...
# Unit tests for Todoist::ProjectVisibility
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::ProjectVisibility do
  let(:instance) { Todoist::ProjectVisibility.new }

  describe "test an instance of ProjectVisibility" do
    it "should create an instance of ProjectVisibility" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::ProjectVisibility)
    end
  end
end
