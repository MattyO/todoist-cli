...
# Unit tests for Todoist::ProjectImportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::ProjectImportResponse do
  let(:instance) { Todoist::ProjectImportResponse.new }

  describe "test an instance of ProjectImportResponse" do
    it "should create an instance of ProjectImportResponse" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::ProjectImportResponse)
    end
  end
