...
# Unit tests for Todoist::CollaboratorRole
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::CollaboratorRole do
  let(:instance) { Todoist::CollaboratorRole.new }

  describe 'test an instance of CollaboratorRole' do
    it 'should create an instance of CollaboratorRole' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::CollaboratorRole)
    end
  end
