...
# Unit tests for Todoist::TodoistAppsApiSyncRestWorkspacesBody2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiSyncRestWorkspacesBody2 do
  let(:instance) { Todoist::TodoistAppsApiSyncRestWorkspacesBody2.new }

  describe 'test an instance of TodoistAppsApiSyncRestWorkspacesBody2' do
    it 'should create an instance of TodoistAppsApiSyncRestWorkspacesBody2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsApiSyncRestWorkspacesBody2)
    end
  end
