...
# Unit tests for Todoist::ProjectImportCreateResponseWithObjects
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::ProjectImportCreateResponseWithObjects do
  let(:instance) { Todoist::ProjectImportCreateResponseWithObjects.new }

  describe 'test an instance of ProjectImportCreateResponseWithObjects' do
    it 'should create an instance of ProjectImportCreateResponseWithObjects' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::ProjectImportCreateResponseWithObjects)
    end
  end
  ...
  describe 'test attribute "project_notes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
