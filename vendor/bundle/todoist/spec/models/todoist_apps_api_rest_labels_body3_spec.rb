...
# Unit tests for Todoist::TodoistAppsApiRestLabelsBody3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestLabelsBody3 do
  let(:instance) { Todoist::TodoistAppsApiRestLabelsBody3.new }

  describe 'test an instance of TodoistAppsApiRestLabelsBody3' do
    it 'should create an instance of TodoistAppsApiRestLabelsBody3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestLabelsBody3)
    end
  end
