...
# Unit tests for Todoist::NotificationType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::NotificationType do
  let(:instance) { Todoist::NotificationType.new }

  describe "test an instance of NotificationType" do
    it "should create an instance of NotificationType" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::NotificationType)
    end
  end
end
