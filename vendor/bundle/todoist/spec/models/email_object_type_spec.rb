...
# Unit tests for Todoist::EmailObjectType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::EmailObjectType do
  let(:instance) { Todoist::EmailObjectType.new }

  describe "test an instance of EmailObjectType" do
    it "should create an instance of EmailObjectType" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::EmailObjectType)
    end
  end
end
