...
# Unit tests for Todoist::PaginatedListSectionSyncView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PaginatedListSectionSyncView do
  let(:instance) { Todoist::PaginatedListSectionSyncView.new }

  describe 'test an instance of PaginatedListSectionSyncView' do
    it 'should create an instance of PaginatedListSectionSyncView' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::PaginatedListSectionSyncView)
    end
  end
