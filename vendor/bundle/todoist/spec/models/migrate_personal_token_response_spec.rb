...
# Unit tests for Todoist::MigratePersonalTokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::MigratePersonalTokenResponse do
  let(:instance) { Todoist::MigratePersonalTokenResponse.new }

  describe "test an instance of MigratePersonalTokenResponse" do
    it "should create an instance of MigratePersonalTokenResponse" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::MigratePersonalTokenResponse)
    end
  end
