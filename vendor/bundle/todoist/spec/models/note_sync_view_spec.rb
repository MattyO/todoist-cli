...
# Unit tests for Todoist::NoteSyncView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::NoteSyncView do
  let(:instance) { Todoist::NoteSyncView.new }

  describe "test an instance of NoteSyncView" do
    it "should create an instance of NoteSyncView" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::NoteSyncView)
    end
  end
  ...
  describe 'test attribute "posted_uid"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
