...
# Unit tests for Todoist::PaginatedListItemSyncView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PaginatedListItemSyncView do
  let(:instance) { Todoist::PaginatedListItemSyncView.new }

  describe 'test an instance of PaginatedListItemSyncView' do
    it 'should create an instance of PaginatedListItemSyncView' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::PaginatedListItemSyncView)
    end
  end
