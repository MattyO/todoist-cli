...
# Unit tests for Todoist::MemberView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::MemberView do
  let(:instance) { Todoist::MemberView.new }

  describe 'test an instance of MemberView' do
    it 'should create an instance of MemberView' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::MemberView)
    end
  end
