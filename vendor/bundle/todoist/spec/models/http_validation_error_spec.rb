...
# Unit tests for Todoist::HTTPValidationError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::HTTPValidationError do
  let(:instance) { Todoist::HTTPValidationError.new }

  describe "test an instance of HTTPValidationError" do
    it "should create an instance of HTTPValidationError" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::HTTPValidationError)
    end
  end
