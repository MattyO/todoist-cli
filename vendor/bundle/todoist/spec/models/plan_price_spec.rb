...
# Unit tests for Todoist::PlanPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PlanPrice do
  let(:instance) { Todoist::PlanPrice.new }

  describe 'test an instance of PlanPrice' do
    it 'should create an instance of PlanPrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::PlanPrice)
    end
  end
