...
# Unit tests for Todoist::PaginatedListCollaborator
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PaginatedListCollaborator do
  let(:instance) { Todoist::PaginatedListCollaborator.new }

  describe 'test an instance of PaginatedListCollaborator' do
    it 'should create an instance of PaginatedListCollaborator' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::PaginatedListCollaborator)
    end
  end
