...
# Unit tests for Todoist::TodoistAppsApiSyncRestWorkspacesBody3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiSyncRestWorkspacesBody3 do
  let(:instance) { Todoist::TodoistAppsApiSyncRestWorkspacesBody3.new }

  describe 'test an instance of TodoistAppsApiSyncRestWorkspacesBody3' do
    it 'should create an instance of TodoistAppsApiSyncRestWorkspacesBody3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsApiSyncRestWorkspacesBody3)
    end
  end
