...
# Unit tests for Todoist::ProjectsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::ProjectsResponse do
  let(:instance) { Todoist::ProjectsResponse.new }

  describe 'test an instance of ProjectsResponse' do
    it 'should create an instance of ProjectsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::ProjectsResponse)
    end
  end
  ...
  describe 'test attribute "workspace_projects"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
