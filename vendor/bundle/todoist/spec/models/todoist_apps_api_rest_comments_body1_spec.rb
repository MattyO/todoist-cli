...
# Unit tests for Todoist::TodoistAppsApiRestCommentsBody1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestCommentsBody1 do
  let(:instance) { Todoist::TodoistAppsApiRestCommentsBody1.new }

  describe "test an instance of TodoistAppsApiRestCommentsBody1" do
    it "should create an instance of TodoistAppsApiRestCommentsBody1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestCommentsBody1)
    end
  end
  ...
  describe 'test attribute "uids_to_notify"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
