...
# Unit tests for Todoist::BackupResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::BackupResponse do
  let(:instance) { Todoist::BackupResponse.new }

  describe 'test an instance of BackupResponse' do
    it 'should create an instance of BackupResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::BackupResponse)
    end
  end
