...
# Unit tests for Todoist::TodoistAppsApiSyncRestQuickBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiSyncRestQuickBody do
  let(:instance) { Todoist::TodoistAppsApiSyncRestQuickBody.new }

  describe 'test an instance of TodoistAppsApiSyncRestQuickBody' do
    it 'should create an instance of TodoistAppsApiSyncRestQuickBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsApiSyncRestQuickBody)
    end
  end
  ...
  describe 'test attribute "auto_reminder"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
