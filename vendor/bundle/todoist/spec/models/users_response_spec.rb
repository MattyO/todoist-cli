...
# Unit tests for Todoist::UsersResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::UsersResponse do
  let(:instance) { Todoist::UsersResponse.new }

  describe "test an instance of UsersResponse" do
    it "should create an instance of UsersResponse" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::UsersResponse)
    end
  end
  ...
  describe 'test attribute "workspace_users"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
