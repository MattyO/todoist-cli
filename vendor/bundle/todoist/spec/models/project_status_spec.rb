...
# Unit tests for Todoist::ProjectStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::ProjectStatus do
  let(:instance) { Todoist::ProjectStatus.new }

  describe 'test an instance of ProjectStatus' do
    it 'should create an instance of ProjectStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::ProjectStatus)
    end
  end
