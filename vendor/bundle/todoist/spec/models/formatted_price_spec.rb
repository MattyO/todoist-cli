...
# Unit tests for Todoist::FormattedPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::FormattedPrice do
  let(:instance) { Todoist::FormattedPrice.new }

  describe "test an instance of FormattedPrice" do
    it "should create an instance of FormattedPrice" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::FormattedPrice)
    end
  end
