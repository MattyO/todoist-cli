...
# Unit tests for Todoist::PersonalProjectSyncView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PersonalProjectSyncView do
  let(:instance) { Todoist::PersonalProjectSyncView.new }

  describe "test an instance of PersonalProjectSyncView" do
    it "should create an instance of PersonalProjectSyncView" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::PersonalProjectSyncView)
    end
  end
  ...
  describe 'test attribute "inbox_project"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
