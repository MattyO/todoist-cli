...
# Unit tests for Todoist::TasksCompletedDateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TasksCompletedDateResponse do
  let(:instance) { Todoist::TasksCompletedDateResponse.new }

  describe 'test an instance of TasksCompletedDateResponse' do
    it 'should create an instance of TasksCompletedDateResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TasksCompletedDateResponse)
    end
  end
