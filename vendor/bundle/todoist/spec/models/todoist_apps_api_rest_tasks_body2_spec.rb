...
# Unit tests for Todoist::TodoistAppsApiRestTasksBody2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestTasksBody2 do
  let(:instance) { Todoist::TodoistAppsApiRestTasksBody2.new }

  describe "test an instance of TodoistAppsApiRestTasksBody2" do
    it "should create an instance of TodoistAppsApiRestTasksBody2" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestTasksBody2)
    end
  end
