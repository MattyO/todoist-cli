...
# Unit tests for Todoist::SectionSyncView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::SectionSyncView do
  let(:instance) { Todoist::SectionSyncView.new }

  describe "test an instance of SectionSyncView" do
    it "should create an instance of SectionSyncView" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::SectionSyncView)
    end
  end
