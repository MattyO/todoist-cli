...
# Unit tests for Todoist::PaginatedListLabelRestView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PaginatedListLabelRestView do
  let(:instance) { Todoist::PaginatedListLabelRestView.new }

  describe 'test an instance of PaginatedListLabelRestView' do
    it 'should create an instance of PaginatedListLabelRestView' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::PaginatedListLabelRestView)
    end
  end
