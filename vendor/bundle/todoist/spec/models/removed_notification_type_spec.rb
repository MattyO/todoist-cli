...
# Unit tests for Todoist::RemovedNotificationType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::RemovedNotificationType do
  let(:instance) { Todoist::RemovedNotificationType.new }

  describe "test an instance of RemovedNotificationType" do
    it "should create an instance of RemovedNotificationType" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::RemovedNotificationType)
    end
  end
end
