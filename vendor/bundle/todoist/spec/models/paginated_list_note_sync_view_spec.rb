...
# Unit tests for Todoist::PaginatedListNoteSyncView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PaginatedListNoteSyncView do
  let(:instance) { Todoist::PaginatedListNoteSyncView.new }

  describe "test an instance of PaginatedListNoteSyncView" do
    it "should create an instance of PaginatedListNoteSyncView" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::PaginatedListNoteSyncView)
    end
  end
