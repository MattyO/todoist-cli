...
# Unit tests for Todoist::TodoistAppsApiRestTasksBody3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestTasksBody3 do
  let(:instance) { Todoist::TodoistAppsApiRestTasksBody3.new }

  describe 'test an instance of TodoistAppsApiRestTasksBody3' do
    it 'should create an instance of TodoistAppsApiRestTasksBody3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestTasksBody3)
    end
  end
