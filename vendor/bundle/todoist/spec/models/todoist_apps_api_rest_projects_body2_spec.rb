...
# Unit tests for Todoist::TodoistAppsApiRestProjectsBody2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestProjectsBody2 do
  let(:instance) { Todoist::TodoistAppsApiRestProjectsBody2.new }

  describe 'test an instance of TodoistAppsApiRestProjectsBody2' do
    it 'should create an instance of TodoistAppsApiRestProjectsBody2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestProjectsBody2)
    end
  end
