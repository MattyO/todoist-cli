...
# Unit tests for Todoist::TodoistAppsApiRestTasksBody1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestTasksBody1 do
  let(:instance) { Todoist::TodoistAppsApiRestTasksBody1.new }

  describe "test an instance of TodoistAppsApiRestTasksBody1" do
    it "should create an instance of TodoistAppsApiRestTasksBody1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestTasksBody1)
    end
  end
  ...
  describe 'test attribute "due_string"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "due_datetime"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "due_lang"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "deadline_lang"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
