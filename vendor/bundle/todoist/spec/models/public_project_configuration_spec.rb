...
# Unit tests for Todoist::PublicProjectConfiguration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PublicProjectConfiguration do
  let(:instance) { Todoist::PublicProjectConfiguration.new }

  describe 'test an instance of PublicProjectConfiguration' do
    it 'should create an instance of PublicProjectConfiguration' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::PublicProjectConfiguration)
    end
  end

  describe 'test attribute "hide_collaborator_details"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "disable_duplication"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
