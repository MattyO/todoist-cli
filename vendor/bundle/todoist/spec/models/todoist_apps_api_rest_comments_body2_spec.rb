...
# Unit tests for Todoist::TodoistAppsApiRestCommentsBody2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestCommentsBody2 do
  let(:instance) { Todoist::TodoistAppsApiRestCommentsBody2.new }

  describe 'test an instance of TodoistAppsApiRestCommentsBody2' do
    it 'should create an instance of TodoistAppsApiRestCommentsBody2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestCommentsBody2)
    end
  end
