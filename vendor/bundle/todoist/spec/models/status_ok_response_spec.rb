...
# Unit tests for Todoist::StatusOkResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::StatusOkResponse do
  let(:instance) { Todoist::StatusOkResponse.new }

  describe "test an instance of StatusOkResponse" do
    it "should create an instance of StatusOkResponse" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::StatusOkResponse)
    end
  end
