...
# Unit tests for Todoist::ProjectAccessView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::ProjectAccessView do
  let(:instance) { Todoist::ProjectAccessView.new }

  describe "test an instance of ProjectAccessView" do
    it "should create an instance of ProjectAccessView" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::ProjectAccessView)
    end
  end
