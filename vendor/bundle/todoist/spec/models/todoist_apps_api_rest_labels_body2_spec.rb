...
# Unit tests for Todoist::TodoistAppsApiRestLabelsBody2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestLabelsBody2 do
  let(:instance) { Todoist::TodoistAppsApiRestLabelsBody2.new }

  describe 'test an instance of TodoistAppsApiRestLabelsBody2' do
    it 'should create an instance of TodoistAppsApiRestLabelsBody2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestLabelsBody2)
    end
  end
