...
# Unit tests for Todoist::NotificationChannel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::NotificationChannel do
  let(:instance) { Todoist::NotificationChannel.new }

  describe 'test an instance of NotificationChannel' do
    it 'should create an instance of NotificationChannel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::NotificationChannel)
    end
  end
