...
# Unit tests for Todoist::FormattedPriceListing
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::FormattedPriceListing do
  let(:instance) { Todoist::FormattedPriceListing.new }

  describe "test an instance of FormattedPriceListing" do
    it "should create an instance of FormattedPriceListing" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::FormattedPriceListing)
    end
  end
