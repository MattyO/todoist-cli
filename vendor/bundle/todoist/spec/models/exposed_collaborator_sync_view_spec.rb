...
# Unit tests for Todoist::ExposedCollaboratorSyncView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::ExposedCollaboratorSyncView do
  let(:instance) { Todoist::ExposedCollaboratorSyncView.new }

  describe 'test an instance of ExposedCollaboratorSyncView' do
    it 'should create an instance of ExposedCollaboratorSyncView' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::ExposedCollaboratorSyncView)
    end
  end
