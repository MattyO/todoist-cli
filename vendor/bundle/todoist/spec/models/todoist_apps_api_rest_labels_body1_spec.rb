...
# Unit tests for Todoist::TodoistAppsApiRestLabelsBody1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestLabelsBody1 do
  let(:instance) { Todoist::TodoistAppsApiRestLabelsBody1.new }

  describe "test an instance of TodoistAppsApiRestLabelsBody1" do
    it "should create an instance of TodoistAppsApiRestLabelsBody1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestLabelsBody1)
    end
  end
