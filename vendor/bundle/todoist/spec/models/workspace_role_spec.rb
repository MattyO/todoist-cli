...
# Unit tests for Todoist::WorkspaceRole
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::WorkspaceRole do
  let(:instance) { Todoist::WorkspaceRole.new }

  describe 'test an instance of WorkspaceRole' do
    it 'should create an instance of WorkspaceRole' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::WorkspaceRole)
    end
  end
