...
# Unit tests for Todoist::EmailResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::EmailResponse do
  let(:instance) { Todoist::EmailResponse.new }

  describe 'test an instance of EmailResponse' do
    it 'should create an instance of EmailResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::EmailResponse)
    end
  end
