...
# Unit tests for Todoist::FileURLResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::FileURLResponse do
  let(:instance) { Todoist::FileURLResponse.new }

  describe 'test an instance of FileURLResponse' do
    it 'should create an instance of FileURLResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::FileURLResponse)
    end
  end
