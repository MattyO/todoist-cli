...
# Unit tests for Todoist::FolderView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::FolderView do
  let(:instance) { Todoist::FolderView.new }

  describe "test an instance of FolderView" do
    it "should create an instance of FolderView" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::FolderView)
    end
  end
