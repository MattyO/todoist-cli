...
# Unit tests for Todoist::EmailObjectTypePre9221
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::EmailObjectTypePre9221 do
  let(:instance) { Todoist::EmailObjectTypePre9221.new }

  describe "test an instance of EmailObjectTypePre9221" do
    it "should create an instance of EmailObjectTypePre9221" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::EmailObjectTypePre9221)
    end
  end
end
