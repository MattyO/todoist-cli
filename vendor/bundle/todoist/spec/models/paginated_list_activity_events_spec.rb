...
# Unit tests for Todoist::PaginatedListActivityEvents
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PaginatedListActivityEvents do
  let(:instance) { Todoist::PaginatedListActivityEvents.new }

  describe "test an instance of PaginatedListActivityEvents" do
    it "should create an instance of PaginatedListActivityEvents" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::PaginatedListActivityEvents)
    end
  end
