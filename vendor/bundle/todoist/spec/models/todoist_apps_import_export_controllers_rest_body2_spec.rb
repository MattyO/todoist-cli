...
# Unit tests for Todoist::TodoistAppsImportExportControllersRestBody2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsImportExportControllersRestBody2 do
  let(:instance) { Todoist::TodoistAppsImportExportControllersRestBody2.new }

  describe "test an instance of TodoistAppsImportExportControllersRestBody2" do
    it "should create an instance of TodoistAppsImportExportControllersRestBody2" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsImportExportControllersRestBody2)
    end
  end
