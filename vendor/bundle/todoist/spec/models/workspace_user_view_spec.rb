...
# Unit tests for Todoist::WorkspaceUserView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::WorkspaceUserView do
  let(:instance) { Todoist::WorkspaceUserView.new }

  describe "test an instance of WorkspaceUserView" do
    it "should create an instance of WorkspaceUserView" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::WorkspaceUserView)
    end
  end
  ...
  describe 'test attribute "custom_sorting_applied"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
