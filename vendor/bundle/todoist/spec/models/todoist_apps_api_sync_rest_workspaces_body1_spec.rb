...
# Unit tests for Todoist::TodoistAppsApiSyncRestWorkspacesBody1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiSyncRestWorkspacesBody1 do
  let(:instance) { Todoist::TodoistAppsApiSyncRestWorkspacesBody1.new }

  describe "test an instance of TodoistAppsApiSyncRestWorkspacesBody1" do
    it "should create an instance of TodoistAppsApiSyncRestWorkspacesBody1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsApiSyncRestWorkspacesBody1)
    end
  end
