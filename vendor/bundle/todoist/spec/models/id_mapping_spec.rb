...
# Unit tests for Todoist::IDMapping
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::IDMapping do
  let(:instance) { Todoist::IDMapping.new }

  describe "test an instance of IDMapping" do
    it "should create an instance of IDMapping" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::IDMapping)
    end
  end
