...
# Unit tests for Todoist::TodoistAppsImportExportControllersRestBody1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsImportExportControllersRestBody1 do
  let(:instance) { Todoist::TodoistAppsImportExportControllersRestBody1.new }

  describe 'test an instance of TodoistAppsImportExportControllersRestBody1' do
    it 'should create an instance of TodoistAppsImportExportControllersRestBody1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsImportExportControllersRestBody1)
    end
  end
