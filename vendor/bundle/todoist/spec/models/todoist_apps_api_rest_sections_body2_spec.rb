...
# Unit tests for Todoist::TodoistAppsApiRestSectionsBody2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestSectionsBody2 do
  let(:instance) { Todoist::TodoistAppsApiRestSectionsBody2.new }

  describe 'test an instance of TodoistAppsApiRestSectionsBody2' do
    it 'should create an instance of TodoistAppsApiRestSectionsBody2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestSectionsBody2)
    end
  end
