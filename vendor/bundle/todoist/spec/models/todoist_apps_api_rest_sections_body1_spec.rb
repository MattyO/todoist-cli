...
# Unit tests for Todoist::TodoistAppsApiRestSectionsBody1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestSectionsBody1 do
  let(:instance) { Todoist::TodoistAppsApiRestSectionsBody1.new }

  describe "test an instance of TodoistAppsApiRestSectionsBody1" do
    it "should create an instance of TodoistAppsApiRestSectionsBody1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestSectionsBody1)
    end
  end
