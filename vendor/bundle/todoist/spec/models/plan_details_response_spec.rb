...
# Unit tests for Todoist::PlanDetailsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::PlanDetailsResponse do
  let(:instance) { Todoist::PlanDetailsResponse.new }

  describe "test an instance of PlanDetailsResponse" do
    it "should create an instance of PlanDetailsResponse" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::PlanDetailsResponse)
    end
  end
  ...
  describe 'test attribute "current_plan"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Business", "Starter"])
  ...
  describe 'test attribute "current_plan_status"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Active", "Downgraded", "Cancelled", "NeverSubscribed"])
      # validator.allowable_values.each do |value|
      #   expect { instance.current_plan_status = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "downgrade_at"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "current_active_projects"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "maximum_active_projects"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "has_trialed"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "has_billing_portal"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "has_billing_portal_switch_to_annual"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
