...
# Unit tests for Todoist::Collaborator
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::Collaborator do
  let(:instance) { Todoist::Collaborator.new }

  describe "test an instance of Collaborator" do
    it "should create an instance of Collaborator" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::Collaborator)
    end
  end
