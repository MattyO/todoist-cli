...
# Unit tests for Todoist::ProjectViewStyle
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::ProjectViewStyle do
  let(:instance) { Todoist::ProjectViewStyle.new }

  describe "test an instance of ProjectViewStyle" do
    it "should create an instance of ProjectViewStyle" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::ProjectViewStyle)
    end
  end
end
