...
# Unit tests for Todoist::TodoistAppsApiRestLabelsBody4
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestLabelsBody4 do
  let(:instance) { Todoist::TodoistAppsApiRestLabelsBody4.new }

  describe "test an instance of TodoistAppsApiRestLabelsBody4" do
    it "should create an instance of TodoistAppsApiRestLabelsBody4" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestLabelsBody4)
    end
  end
