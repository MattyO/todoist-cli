...
# Unit tests for Todoist::WorkspaceProjectView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::WorkspaceProjectView do
  let(:instance) { Todoist::WorkspaceProjectView.new }

  describe 'test an instance of WorkspaceProjectView' do
    it 'should create an instance of WorkspaceProjectView' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::WorkspaceProjectView)
    end
  end

  describe 'test attribute "initiated_by_uid"' do
    it 'should work' do
  ...
  describe 'test attribute "public_access"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "archived_timestamp"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "_v1_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "_role"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
