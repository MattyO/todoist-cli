...
# Unit tests for Todoist::LabelRestView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::LabelRestView do
  let(:instance) { Todoist::LabelRestView.new }

  describe "test an instance of LabelRestView" do
    it "should create an instance of LabelRestView" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::LabelRestView)
    end
  end
