...
# Unit tests for Todoist::UploadResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::UploadResult do
  let(:instance) { Todoist::UploadResult.new }

  describe 'test an instance of UploadResult' do
    it 'should create an instance of UploadResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Todoist::UploadResult)
    end
  end
  ...
  describe 'test attribute "upload_state"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "completed"])
      # validator.allowable_values.each do |value|
      #   expect { instance.upload_state = value }.not_to raise_error
      # end
    end
  end
