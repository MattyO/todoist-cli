...
# Unit tests for Todoist::TodoistAppsApiSyncRestControllerBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiSyncRestControllerBody do
  let(:instance) { Todoist::TodoistAppsApiSyncRestControllerBody.new }

  describe "test an instance of TodoistAppsApiSyncRestControllerBody" do
    it "should create an instance of TodoistAppsApiSyncRestControllerBody" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsApiSyncRestControllerBody)
    end
  end
