...
# Unit tests for Todoist::GetDataV2Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::GetDataV2Response do
  let(:instance) { Todoist::GetDataV2Response.new }

  describe "test an instance of GetDataV2Response" do
    it "should create an instance of GetDataV2Response" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::GetDataV2Response)
    end
  end
  ...
  describe 'test attribute "collaborator_states"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "subprojects"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
