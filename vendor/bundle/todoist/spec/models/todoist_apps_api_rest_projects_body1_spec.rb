...
# Unit tests for Todoist::TodoistAppsApiRestProjectsBody1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Todoist::TodoistAppsApiRestProjectsBody1 do
  let(:instance) { Todoist::TodoistAppsApiRestProjectsBody1.new }

  describe "test an instance of TodoistAppsApiRestProjectsBody1" do
    it "should create an instance of TodoistAppsApiRestProjectsBody1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Todoist::TodoistAppsApiRestProjectsBody1)
    end
  end
