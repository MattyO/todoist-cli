...
module Todoist
  class BackupsApi
    ...
    # @return [Object]
    def download_backup_api_v1_backups_download_get(file, opts = {})
      data, _status_code, _headers = download_backup_api_v1_backups_download_get_with_http_info(file, opts)
      data
    end
    ...
    def download_backup_api_v1_backups_download_get_with_http_info(file, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BackupsApi.download_backup_api_v1_backups_download_get ...'
      end
      # verify the required parameter 'file' is set
      if @api_client.config.client_side_validation && file.nil?
        fail ArgumentError, "Missing the required parameter 'file' when calling BackupsApi.download_backup_api_v1_backups_download_get"
      end
      # resource path
      local_var_path = '/api/v1/backups/download'
      ...
      new_options = opts.merge(
        :operation => :"BackupsApi.download_backup_api_v1_backups_download_get",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BackupsApi#download_backup_api_v1_backups_download_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_backups_api_v1_backups_get(opts = {})
      data, _status_code, _headers = get_backups_api_v1_backups_get_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :mfa_token 
    # @return [Array<(Array<BackupResponse>, Integer, Hash)>] Array<BackupResponse> data, response status code and response headers
    def get_backups_api_v1_backups_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BackupsApi.get_backups_api_v1_backups_get ...'
      end
      # resource path
      local_var_path = '/api/v1/backups'

      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'mfa_token'] = opts[:'mfa_token'] if !opts[:'mfa_token'].nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<BackupResponse>'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"BackupsApi.get_backups_api_v1_backups_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BackupsApi#get_backups_api_v1_backups_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
