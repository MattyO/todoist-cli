...
module Todoist
  class ProjectVisibility
    ...
    def self.all_vars
      @all_vars ||= [RESTRICTED, TEAM, PUBLIC].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProjectVisibility.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProjectVisibility"
    end
  end
end
