...
module Todoist
  class RemovedNotificationType
    BIZ_TRIAL_ENTER_CC = "biz_trial_enter_cc".freeze
    BIZ_TRIAL_WILL_END = "biz_trial_will_end".freeze
    BIZ_PAYMENT_FAILED = "biz_payment_failed".freeze
    BIZ_ACCOUNT_DISABLED = "biz_account_disabled".freeze
    BIZ_INVITATION_CREATED = "biz_invitation_created".freeze
    BIZ_INVITATION_ACCEPTED = "biz_invitation_accepted".freeze
    BIZ_INVITATION_REJECTED = "biz_invitation_rejected".freeze
    BIZ_POLICY_DISALLOWED_INVITATION = "biz_policy_disallowed_invitation".freeze
    BIZ_POLICY_REJECTED_INVITATION = "biz_policy_rejected_invitation".freeze

    def self.all_vars
      @all_vars ||= [BIZ_TRIAL_ENTER_CC, BIZ_TRIAL_WILL_END, BIZ_PAYMENT_FAILED, BIZ_ACCOUNT_DISABLED, BIZ_INVITATION_CREATED, BIZ_INVITATION_ACCEPTED, BIZ_INVITATION_REJECTED, BIZ_POLICY_DISALLOWED_INVITATION, BIZ_POLICY_REJECTED_INVITATION].freeze
    end
    ...
    def build_from_hash(value)
      return value if RemovedNotificationType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #RemovedNotificationType"
    end
  end
end
