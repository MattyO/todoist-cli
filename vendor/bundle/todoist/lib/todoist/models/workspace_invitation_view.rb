  ...
  class WorkspaceInvitationView
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Todoist::WorkspaceInvitationView` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !acceptable_attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Todoist::WorkspaceInvitationView`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      self.inviter_id = if attributes.key?(:inviter_id)
        attributes[:inviter_id]
      end
      ...
      self.is_existing_user = if attributes.key?(:is_existing_user)
        attributes[:is_existing_user]
      end
    end
    ...
    def list_invalid_properties
      ...
      if @is_existing_user.nil?
        invalid_properties.push('invalid value for "is_existing_user", is_existing_user cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_existing_user.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] is_existing_user Value to be assigned
    def is_existing_user=(is_existing_user)
      if is_existing_user.nil?
        fail ArgumentError, "is_existing_user cannot be nil"
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        role == other.role &&
        id == other.id &&
        is_existing_user == other.is_existing_user
    end
    ...
    def hash
      [inviter_id, user_email, workspace_id, role, id, is_existing_user].hash
    end
