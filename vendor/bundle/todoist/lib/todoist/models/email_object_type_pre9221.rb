...
module Todoist
  class EmailObjectTypePre9221
    ...
    PROJECT_COMMENTS = "project_comments".freeze
    ITEM = "item".freeze

    def self.all_vars
      @all_vars ||= [PROJECT, PROJECT_COMMENTS, ITEM].freeze
    end
    ...
    def build_from_hash(value)
      return value if EmailObjectTypePre9221.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #EmailObjectTypePre9221"
    end
  end
end
