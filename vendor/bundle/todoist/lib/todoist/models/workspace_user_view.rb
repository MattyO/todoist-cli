...
module Todoist
  class WorkspaceUserView
    ...
    def initialize(attributes = {})
      ...
      self.custom_sorting_applied = if attributes.key?(:custom_sorting_applied)
        attributes[:custom_sorting_applied]
      else
        false
      end
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        role == other.role &&
        custom_sorting_applied == other.custom_sorting_applied
    end
