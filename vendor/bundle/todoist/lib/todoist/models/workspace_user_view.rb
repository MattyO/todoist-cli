...
module Todoist
  class WorkspaceUserView
    ...
    attr_accessor :custom_sorting_applied
    ...
    def self.attribute_map
      {
        ...
        :'role' => :'role',
        :'custom_sorting_applied' => :'custom_sorting_applied'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Todoist::WorkspaceUserView` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Todoist::WorkspaceUserView`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'custom_sorting_applied')
        self.custom_sorting_applied = attributes[:'custom_sorting_applied']
      else
        self.custom_sorting_applied = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          role == o.role &&
          custom_sorting_applied == o.custom_sorting_applied
    end
    ...
    def hash
      [user_id, workspace_id, role, custom_sorting_applied].hash
    end
