...
module Todoist
  class CollaboratorRole
    ...
    READ_AND_COMMENT = "READ_AND_COMMENT".freeze
    READ_ONLY = "READ_ONLY".freeze

    def self.all_vars
      @all_vars ||= [CREATOR, ADMIN, READ_WRITE, READ_AND_COMMENT, READ_ONLY].freeze
    end
    ...
    def build_from_hash(value)
      return value if CollaboratorRole.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #CollaboratorRole"
    end
  end
end
