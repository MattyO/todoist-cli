...
module Todoist
  class UploadResult
    ...
    def initialize(attributes = {})
      ...
      self.file_size = if attributes.key?(:file_size)
        attributes[:file_size]
      end

      self.file_type = if attributes.key?(:file_type)
        attributes[:file_type]
      end

      self.resource_type = if attributes.key?(:resource_type)
      ...
      self.upload_state = if attributes.key?(:upload_state)
        attributes[:upload_state]
      else
        "pending"
      end
    end
