...
module Todoist
  class ProjectStatus
    ...
    def self.all_vars
      @all_vars ||= [PLANNED, IN_PROGRESS, PAUSED, COMPLETED, CANCELED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProjectStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProjectStatus"
    end
  end
end
