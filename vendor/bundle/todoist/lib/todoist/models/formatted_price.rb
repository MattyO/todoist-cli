  ...
  class FormattedPrice
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Todoist::FormattedPrice` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !acceptable_attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Todoist::FormattedPrice`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      self.unit_amount = if attributes.key?(:unit_amount)
        attributes[:unit_amount]
      end

      self.tax_behavior = if attributes.key?(:tax_behavior)
    ...
    def list_invalid_properties
      ...
      if @tax_behavior.nil?
        invalid_properties.push('invalid value for "tax_behavior", tax_behavior cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] tax_behavior Value to be assigned
    def tax_behavior=(tax_behavior)
      if tax_behavior.nil?
        fail ArgumentError, "tax_behavior cannot be nil"
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        unit_amount == other.unit_amount &&
        tax_behavior == other.tax_behavior
    end
    ...
    def hash
      [currency, unit_amount, tax_behavior].hash
    end
