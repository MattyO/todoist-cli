...
module Todoist
  ...
  class ItemSyncView
    ...
    def initialize(attributes = {})
      ...
      self.section_id = if attributes.key?(:section_id)
        attributes[:section_id]
      end

      self.parent_id = if attributes.key?(:parent_id)
        attributes[:parent_id]
      end

      self.added_by_uid = if attributes.key?(:added_by_uid)
        attributes[:added_by_uid]
      end

      self.assigned_by_uid = if attributes.key?(:assigned_by_uid)
        attributes[:assigned_by_uid]
      end

      self.responsible_uid = if attributes.key?(:responsible_uid)
        attributes[:responsible_uid]
      end
      ...
      self.checked = if attributes.key?(:checked)
        attributes[:checked]
      end
      ...
      self.added_at = if attributes.key?(:added_at)
        attributes[:added_at]
      end

      self.completed_at = if attributes.key?(:completed_at)
      ...
      self.priority = if attributes.key?(:priority)
        attributes[:priority]
      end
      ...
      self.note_count = if attributes.key?(:note_count)
        attributes[:note_count]
      end

      self.day_order = if attributes.key?(:day_order)
        attributes[:day_order]
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        added_by_uid == other.added_by_uid &&
        assigned_by_uid == other.assigned_by_uid &&
        responsible_uid == other.responsible_uid &&
        labels == other.labels &&
