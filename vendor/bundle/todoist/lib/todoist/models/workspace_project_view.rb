...
module Todoist
  class WorkspaceProjectView
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'initiated_by_uid')
        self.initiated_by_uid = attributes[:'initiated_by_uid']
      else
        self.initiated_by_uid = nil
      end
      ...
      if attributes.key?(:'public_access')
        self.public_access = attributes[:'public_access']
      else
        self.public_access = nil
      end
      ...
      if attributes.key?(:'archived_timestamp')
        self.archived_timestamp = attributes[:'archived_timestamp']
      else
        self.archived_timestamp = 0
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          initiated_by_uid == o.initiated_by_uid &&
          project_id == o.project_id &&
          workspace_id == o.workspace_id &&
          public_access == o.public_access &&
          access == o.access &&
          folder_id == o.folder_id &&
          is_invite_only == o.is_invite_only &&
          is_archived == o.is_archived &&
          archived_timestamp == o.archived_timestamp &&
