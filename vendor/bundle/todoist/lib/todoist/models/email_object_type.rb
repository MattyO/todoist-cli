...
module Todoist
  class EmailObjectType
    ...
    def self.all_vars
      @all_vars ||= [PROJECT, PROJECT_COMMENTS, TASK].freeze
    end
    ...
    def build_from_hash(value)
      return value if EmailObjectType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #EmailObjectType"
    end
  end
end
