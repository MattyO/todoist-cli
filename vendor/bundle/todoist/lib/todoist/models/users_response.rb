  ...
  class UsersResponse
    ...
    def self.openapi_types
      {
        has_more: :Boolean,
        next_cursor: :String,
        workspace_users: :"Array<MemberView>"
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Todoist::UsersResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !acceptable_attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Todoist::UsersResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:workspace_users)
        if (value = attributes[:workspace_users]).is_a?(Array)
          self.workspace_users = value
        end
      else
        self.workspace_users = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @workspace_users.nil?
        invalid_properties.push('invalid value for "workspace_users", workspace_users cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @workspace_users.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] workspace_users Value to be assigned
    def workspace_users=(workspace_users)
      if workspace_users.nil?
        fail ArgumentError, "workspace_users cannot be nil"
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        workspace_users == other.workspace_users
    end
    ...
    def hash
      [has_more, next_cursor, workspace_users].hash
    end
