...
module Todoist
  class PublicProjectConfiguration
    attr_accessor :hide_collaborator_details

    attr_accessor :disable_duplication

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'hide_collaborator_details' => :'hide_collaborator_details',
        :'disable_duplication' => :'disable_duplication'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Todoist::PublicProjectConfiguration` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Todoist::PublicProjectConfiguration`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'hide_collaborator_details')
        self.hide_collaborator_details = attributes[:'hide_collaborator_details']
      else
        self.hide_collaborator_details = nil
      end

      if attributes.key?(:'disable_duplication')
        self.disable_duplication = attributes[:'disable_duplication']
      else
        self.disable_duplication = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @hide_collaborator_details.nil?
        invalid_properties.push('invalid value for "hide_collaborator_details", hide_collaborator_details cannot be nil.')
      end

      if @disable_duplication.nil?
        invalid_properties.push('invalid value for "disable_duplication", disable_duplication cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @hide_collaborator_details.nil?
      return false if @disable_duplication.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] hide_collaborator_details Value to be assigned
    def hide_collaborator_details=(hide_collaborator_details)
      if hide_collaborator_details.nil?
        fail ArgumentError, 'hide_collaborator_details cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] disable_duplication Value to be assigned
    def disable_duplication=(disable_duplication)
      if disable_duplication.nil?
        fail ArgumentError, 'disable_duplication cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          hide_collaborator_details == o.hide_collaborator_details &&
          disable_duplication == o.disable_duplication
    end
    ...
    def hash
      [hide_collaborator_details, disable_duplication].hash
    end
