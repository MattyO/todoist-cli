...
module Todoist
  class ProjectsResponse
    ...
    attr_accessor :workspace_projects
    ...
    def self.openapi_types
      {
        has_more: :Boolean,
        next_cursor: :String,
        workspace_projects: :"Array<WorkspaceProjectView>"
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Todoist::ProjectsResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !acceptable_attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Todoist::ProjectsResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      self.has_more = if attributes.key?(:has_more)
        attributes[:has_more]
      end
      ...
      if attributes.key?(:workspace_projects)
        if (value = attributes[:workspace_projects]).is_a?(Array)
          self.workspace_projects = value
        end
      else
        self.workspace_projects = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @workspace_projects.nil?
        invalid_properties.push('invalid value for "workspace_projects", workspace_projects cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @workspace_projects.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] workspace_projects Value to be assigned
    def workspace_projects=(workspace_projects)
      if workspace_projects.nil?
        fail ArgumentError, "workspace_projects cannot be nil"
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        workspace_projects == other.workspace_projects
    end
    ...
    def hash
      [has_more, next_cursor, workspace_projects].hash
    end
