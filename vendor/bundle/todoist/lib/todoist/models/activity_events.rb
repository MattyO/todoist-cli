...
module Todoist
  class ActivityEvents
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'v2_object_id')
        self.v2_object_id = attributes[:'v2_object_id']
      else
        self.v2_object_id = nil
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          v2_object_id == o.v2_object_id &&
          event_type == o.event_type &&
          event_date == o.event_date &&
          id == o.id &&
          parent_project_id == o.parent_project_id &&
          v2_parent_project_id == o.v2_parent_project_id &&
          parent_item_id == o.parent_item_id &&
          v2_parent_item_id == o.v2_parent_item_id &&
          initiator_id == o.initiator_id &&
          extra_data_id == o.extra_data_id &&
