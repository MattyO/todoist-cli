  ...
  class TodoistAppsApiRestCommentsBody1
    ...
    def self.openapi_types
      {
        ...
        task_id: :TaskId3,
        attachment: :"Hash<String, Object>",
        uids_to_notify: :"Array<Integer>"
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Todoist::TodoistAppsApiRestCommentsBody1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !acceptable_attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Todoist::TodoistAppsApiRestCommentsBody1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:attachment)
        if (value = attributes[:attachment]).is_a?(Hash)
    ...
    def list_invalid_properties
      ...
      if @content.to_s.length > 15000
        invalid_properties.push('invalid value for "content", the character length must be smaller than or equal to 15000.')
      end
    ...
    def valid?
      ...
      return false if @content.to_s.length > 15000
    ...
    def content=(content)
      ...
      if content.to_s.length > 15000
        fail ArgumentError, 'invalid value for "content", the character length must be smaller than or equal to 15000.'
      end
    ...
    def hash
      [content, project_id, task_id, attachment, uids_to_notify].hash
    end
